...
CU_HXR_design_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
CU_HXR_live_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())
CU_HXR_design_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())

# CU_SXR
CU_SXR_live_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
CU_SXR_design_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
CU_SXR_live_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())
CU_SXR_design_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())

# SC_HXR
SC_HXR_live_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_HXR_design_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_HXR_live_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())
SC_HXR_design_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())

# SC_SXR
SC_SXR_live_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_SXR_design_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_SXR_live_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())
SC_SXR_design_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())

# SC_DIAG0
SC_DIAG0_live_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_DIAG0_design_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_DIAG0_live_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())
SC_DIAG0_design_rmat_pv = SharedPV(nt=rmat_table_type, initial=initial_rmat_table, handler=Handler())

# SC_BSYD
SC_BSYD_live_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
SC_BSYD_design_twiss_pv = SharedPV(nt=twiss_table_type, initial=initial_twiss_table, handler=Handler())
...
# kill it.
pva_server = PVAServer.forever(providers=[{f"BLEM:SYS0:1:CU_HXR:LIVE:TWISS": CU_HXR_live_twiss_pv,
					   f"BLEM:SYS0:1:CU_HXR:DESIGN:TWISS": CU_HXR_design_twiss_pv,
					   f"BLEM:SYS0:1:CU_HXR:LIVE:RMAT": CU_HXR_live_rmat_pv,
					   f"BLEM:SYS0:1:CU_HXR:DESIGN:RMAT": CU_HXR_design_rmat_pv,
					   f"BLEM:SYS0:1:CU_SXR:LIVE:TWISS": CU_SXR_live_twiss_pv,
					   f"BLEM:SYS0:1:CU_SXR:DESIGN:TWISS": CU_SXR_design_twiss_pv,
					   f"BLEM:SYS0:1:CU_SXR:LIVE:RMAT": CU_SXR_live_rmat_pv,
					   f"BLEM:SYS0:1:CU_SXR:DESIGN:RMAT": CU_SXR_design_rmat_pv,
					   f"BLEM:SYS0:1:SC_HXR:LIVE:TWISS": SC_HXR_live_twiss_pv,
					   f"BLEM:SYS0:1:SC_HXR:DESIGN:TWISS": SC_HXR_design_twiss_pv,
					   f"BLEM:SYS0:1:SC_HXR:LIVE:RMAT": SC_HXR_live_rmat_pv,
					   f"BLEM:SYS0:1:SC_HXR:DESIGN:RMAT": SC_HXR_design_rmat_pv,
					   f"BLEM:SYS0:1:SC_SXR:LIVE:TWISS": SC_SXR_live_twiss_pv,
					   f"BLEM:SYS0:1:SC_SXR:DESIGN:TWISS": SC_SXR_design_twiss_pv,
					   f"BLEM:SYS0:1:SC_SXR:LIVE:RMAT": SC_SXR_live_rmat_pv,
					   f"BLEM:SYS0:1:SC_SXR:DESIGN:RMAT": SC_SXR_design_rmat_pv,
					   f"BLEM:SYS0:1:SC_DIAG0:LIVE:TWISS": SC_DIAG0_live_twiss_pv,
					   f"BLEM:SYS0:1:SC_DIAG0:DESIGN:TWISS": SC_DIAG0_design_twiss_pv,
					   f"BLEM:SYS0:1:SC_DIAG0:LIVE:RMAT": SC_DIAG0_live_rmat_pv,
					   f"BLEM:SYS0:1:SC_DIAG0:DESIGN:RMAT": SC_DIAG0_design_rmat_pv,
